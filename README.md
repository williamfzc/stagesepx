...
项目发展至今，基础需求已经逐步进入稳定与可用阶段。接下来我们会逐步进行：

- 更好的业务向落地方案
- 新需求的开发

这个项目的初衷就是鼓励共同开发，欢迎所有**感兴趣的同学或者团队**加入，更好地落地才能带来更大的价值。参与者将可以更好地理解并将这些技术应用到实处，定制更贴合业务的功能，推动整个项目的发展。
